...
class UserAction():
    def __init__(self) -> None:
        ...
        self.register_user_sql_session = PostgresqlServer().get_register_user_session() 
        self.user_like_sql_session = PostgresqlServer().get_user_like_session()
        self.user_collection_sql_session = PostgresqlServer().get_user_collection_session()
        self.user_read_sql_session = PostgresqlServer().get_user_read_session()
